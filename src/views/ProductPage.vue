            ...
            <section class="py-10">
                <div class="max-w-[1280px] mx-auto px-6">
                    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                        <div>
                            <div class="text-[#0060b0] font-bold text-xs tracking-widest uppercase mb-2">PRODUCT CENTER
                            </div>
                            <h1 class="text-3xl font-black text-slate-900">产品分类</h1>
                            <p class="text-slate-500 text-sm mt-2">专业化工材料解决方案提供商</p>
                        </div>
                        <div class="w-full md:w-auto">
                            <div class="relative group">
                                <input v-model="searchQuery" type="text" placeholder="全局搜索：产品名 / CAS号 / 用途"
                        ...
                        <aside class="lg:col-span-3">
                            <div
                                ...
                                <div class="hidden lg:block px-4 py-3 border-b border-slate-100 bg-slate-50/50">
                                    <div class="text-sm font-bold text-slate-800">产品大类</div>
                                </div>
                                ...
                                <ul
                                    ...
                                    <li v-for="(cat, index) in productData" :key="index" class="shrink-0 lg:w-full">
                                        <button @click="activeCategoryIndex = index" :class="['w-full text-left px-4 py-2 text-sm rounded transition-all whitespace-nowrap lg:whitespace-normal',
                                ...
                                <div
                                    ...
                                    <div>
                                        <h2 class="text-lg font-bold text-slate-900">
                                            {{ isSearching ? '搜索结果' : productData[activeCategoryIndex]?.name }}
                                        </h2>
                                    </div>
